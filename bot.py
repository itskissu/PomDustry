    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL1:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/kissuhelp for support")
                sys.exit()
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/kissuhelp for support")
            sys.exit()
        ...
        self.LOGGER(__name__).info(f"Bot Running..! Made by @kissubots")   
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote>🤖 Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ by @kissubots</blockquote></b>")
        except: pass
